...
export const AccessibilityWidget = () => {
  ...
  return (
    <div className="fixed left-4 bottom-[calc(var(--mobile-cta-clearance)_+_env(safe-area-inset-bottom,0px)_+_0.75rem)] z-40 md:bottom-4">
      <button
        ref={buttonRef}
        type="button"
        onClick={() => setOpen((v) => !v)}
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute left-0 bottom-14 w-76 max-w-[calc(100vw-2.5rem)] rounded-2xl border border-border bg-white p-5 shadow-[0_24px_56px_-24px_rgba(38,70,83,0.4)]"
          >
            <div className="mb-4 flex items-center justify-between">
              ...
              <button
                ...
                className="rounded-md p-1 text-(--text-muted) hover:bg-muted focus:outline-none focus-visible:ring-2 focus-visible:ring-(--brand-primary)"
              >
            ...
            {/* Text size */}
            <div className="mb-4">
              <div className="mb-2 flex items-center gap-2 font-ui text-xs font-semibold uppercase tracking-wider text-(--text-muted)">
