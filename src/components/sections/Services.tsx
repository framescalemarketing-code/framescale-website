...
export function ServiceOverview() {
  return (
    <Section size="default">
      <SectionHeading title={servicesSection.title} lead={servicesSection.lead} className="max-w-3xl" />
...
export function ServiceDetails() {
  return (
    <Section tone="muted" size="default">
      <SectionHeading title={servicesSection.title} lead={servicesSection.lead} className="max-w-2xl" />
