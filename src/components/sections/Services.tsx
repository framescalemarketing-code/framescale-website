...
export function ServiceOverview() {
  return (
    <Section size="default">
      <SectionHeading title="What I Do" lead="Most owners need more than one of these." className="max-w-3xl" />
...
export function ServiceDetails() {
  return (
    <Section tone="muted" size="default">
      <SectionHeading title="What I Do" lead="Most owners need more than one of these." className="max-w-2xl" />
