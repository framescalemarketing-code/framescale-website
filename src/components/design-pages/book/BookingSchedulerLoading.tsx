...
export const BookingSchedulerLoading = () => (
  <section className="relative pb-16 sm:pb-20 lg:pb-28 bg-white">
    <div className={PAGE_SHELL_BOOK_MAIN}>
      <div className="rounded-2xl border border-(--brand-primary)/20 bg-linear-to-br from-(--brand-primary)/5 to-(--brand-secondary)/5 p-8 sm:p-10 flex flex-col items-center justify-center min-h-[320px] gap-3">
